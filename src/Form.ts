...
export class Form {
    ...
    constructor(id: string) {
        ...
        this.fields.push(new SelectInputText('Wybrany kierunek studiów', 'Wybrany kierunek studiów', 'Wybrany kierunek studiów', ['Ekonometria', 'Zielarstwo', 'Programista']))
        ...
        this.fields.push(new SelectInputText('Kraj', 'Kraj', 'Kraj', []))
    }
    render(): void {
